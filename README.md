Hearsay Administrator Interface
===============================

#### Introduction:
An admin interface for managing sources for Hearsay
 ...
 * example: `development`
* `ADMIN_TOKEN` - Secret token for logging into the admin service
 * example: `keyboardcat12345`
